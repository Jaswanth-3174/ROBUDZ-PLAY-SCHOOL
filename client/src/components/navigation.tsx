              ...
              <div className="ml-10 flex items-baseline space-x-4">
                {navItems.map((item, index) => (
                  <motion.button
                    ...
                    className="text-foreground hover:text-coral transition-colors duration-300 px-3 py-2 rounded-md text-sm font-medium"
                ...
                <motion.button
                  ...
                  className="bg-gradient-to-r from-coral to-turquoise text-white px-6 py-2 rounded-full hover:shadow-lg transition-all duration-300 transform hover:scale-105"
